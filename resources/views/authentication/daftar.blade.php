    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-12">
        ...
        <div class="bg-white p-8 rounded-lg shadow-md mx-12 sm:mx-0">
            ...
            <form>
                ...
                <button class="bg-biru hover:bg-blue-600 text-white font-bold py-2 px-4 rounded w-full">Daftar</button>
            </form>
            ...
            <p class="text-gray-600 text-sm mt-4">Sudah mempunyai akun? <a
                href="/masuk" class="text-biru hover:text-birumud">Masuk</a></p>
        </div>
    </div>
</div>
